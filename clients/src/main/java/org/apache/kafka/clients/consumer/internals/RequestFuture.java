 ...
 *    not have been successful, but a . In this case, use {@link #retryAction()} to </li>
 * </ol>
 *
...
public class RequestFuture<T> {
    ...
    public static final RequestFuture<Object> NEED_BACKOFF = newRetryFuture(RetryAction.BACKOFF);
    ...
    public void retryAfterPoll() {
        retry(RetryAction.POLL);
    }
    ...
    public static <T> RequestFuture<T> backoffNeeded() {
        return (RequestFuture<T>) NEED_BACKOFF;
    }
