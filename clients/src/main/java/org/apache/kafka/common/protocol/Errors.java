...
public enum Errors {
    ...
    DUPLICATE_BROKER_REGISTRATION(100, "Duplicate broker registration", DuplicateBrokerRegistrationException::new),
    INVALID_CLUSTER_ID(101, "Invalid cluster ID.", InvalidClusterIdException::new);
