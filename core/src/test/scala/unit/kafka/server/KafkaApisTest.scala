...
import kafka.server.DynamicConfig.Broker.LeaderReplicationThrottledRateProp
import kafka.server.QuotaFactory.QuotaManagers
import kafka.server.metadata.{ConfigRepository, LocalConfigRepository, ZkConfigRepository}
...
class KafkaApisTest {
  ...
  private val configRepository: ZkConfigRepository = new ZkConfigRepository(new AdminZkClient(zkClient))
  ...
  def createKafkaApisKip500(interBrokerProtocolVersion: ApiVersion = ApiVersion.latestVersion,
    ...
    createKafkaApis(interBrokerProtocolVersion, authorizer, true, metadataCache, null)
  }
  ...
  def testFilterByAuthorized(): Unit = {
    ...
    val result = createKafkaApis(authorizer = Some(authorizer)).authHelper.filterByAuthorized(
      requestContext,
      operation,
      resourceType,
  ...
  def testDescribeConfigsWithNullConfigurationKeysKip500(): Unit = {
    ...
    EasyMock.replay(mockMetadataCache)

    val resources = List(new DescribeConfigsRequestData.DescribeConfigsResource()
      .setResourceName(topic)
      .setResourceType(ConfigResource.Type.TOPIC.id)
      .setConfigurationKeys(null))
    val kafkaApis = createKafkaApisKip500(metadataCache = mockMetadataCache)
    kafkaApis.configRepository.asInstanceOf[LocalConfigRepository].
      setConfig(new ConfigResource(ConfigResource.Type.TOPIC, topic), "foo", "bar")
  ...
  def testDescribeConfigsWithEmptyConfigurationKeysKip500(): Unit = {
    ...
    val localConfigRepository = new LocalConfigRepository()
    localConfigRepository.setConfig(topicResource, "foo", "bar")
    EasyMock.expect(mockMetadataCache.contains(topic)).andReturn(true)
    EasyMock.replay(mockMetadataCache)
  ...
  def testDescribeConfigsWithDocumentationKip500(): Unit = {
    ...
    val localConfigRepository = new LocalConfigRepository()
    localConfigRepository.setBrokerConfig(brokerId, LeaderReplicationThrottledRateProp, "123")
  ...
  def testInvalidEnvelopeRequestAsPrimary(): Unit = {
    ...
    val response = readResponse(envelopeRequest, capturedResponse).asInstanceOf[EnvelopeResponse]
  ...
  private def testInvalidEnvelopeRequest(expectedError: Errors,
    ...
    if (shouldCloseConnection) {
      assertTrue(false) //capturedResponse.getValue.isInstanceOf[CloseConnectionResponse])
    } else {
      val envelopeRequest = request.body[EnvelopeRequest]
      val response = readResponse(envelopeRequest, capturedResponse)
        .asInstanceOf[EnvelopeResponse]
  ...
  def testAlterConfigsWithAuthorizer(): Unit = {
    ...
    verifyAlterConfigResult(request, alterConfigsRequest,
  ...
  private def verifyAlterConfigResult(request: RequestChannel.Request,
  ...
  def testIncrementalAlterConfigsWithAuthorizer(): Unit = {
    ...
    verifyIncrementalAlterConfigResult(request, incrementalAlterConfigsRequest,
      capturedResponse, Map(authorizedTopic -> Errors.NONE,
        unauthorizedTopic -> Errors.TOPIC_AUTHORIZATION_FAILED))
  ...
  private def verifyIncrementalAlterConfigResult(request: RequestChannel.Request,
  ...
  def testAlterClientQuotasWithAuthorizer(): Unit = {
    ...
    verifyAlterClientQuotaResult(request, alterClientQuotasRequest,
  ...
  private def verifyAlterClientQuotaResult(request: RequestChannel.Request,
  ...
  def testCreateTopicsWithAuthorizer(): Unit = {
    ...
    verifyCreateTopicsResult(request, createTopicsRequest,
      capturedResponse, Map(authorizedTopic -> Errors.NONE,
        unauthorizedTopic -> Errors.TOPIC_AUTHORIZATION_FAILED))
  ...
  private def verifyCreateTopicsResult(request: RequestChannel.Request,
                                       createTopicsRequest: CreateTopicsRequest,
                                       capturedResponse: Capture[RequestChannel.Response],
                                       expectedResults: Map[String, Errors]): Unit = {
    val response = readResponse(createTopicsRequest, capturedResponse).asInstanceOf[CreateTopicsResponse]
  ...
  def testTxnOffsetCommitWithInvalidPartition(): Unit = {
    ...
    def checkInvalidPartition(invalidPartitionId: Int): Unit = {
      ...
      val response = readResponse(offsetCommitRequest, capturedResponse).asInstanceOf[TxnOffsetCommitResponse]
  ...
  def testOffsetDeleteWithInvalidGroup(): Unit = {
    ...
    val response = readResponse(offsetDeleteRequest, capturedResponse).asInstanceOf[OffsetDeleteResponse]
  ...
  def testMetadataRequestOnSharedListenerWithInconsistentListenersAcrossBrokers(): Unit = {
    ...
    val response = sendMetadataRequestWithInconsistentListeners(plaintextListener).asInstanceOf[MetadataResponse]
  ...
  def testMetadataRequestOnDistinctListenerWithInconsistentListenersAcrossBrokers(): Unit = {
    ...
    val response = sendMetadataRequestWithInconsistentListeners(anotherListener).asInstanceOf[MetadataResponse]
  ...
  def rejectHeartbeatRequestWhenStaticMembershipNotSupported(): Unit = {
    ...
    val response = readResponse(heartbeatRequest, capturedResponse)
      .asInstanceOf[HeartbeatResponse]
    assertEquals(Errors.UNSUPPORTED_VERSION, response.error())
    EasyMock.replay(groupCoordinator)
  }
  ...
  def testUpdateMetadataRequest(currentBrokerEpoch: Long, brokerEpochInRequest: Long, expectedError: Errors): Unit = {
    ...
    val response = readResponse(updateMetadataRequest, capturedResponse)
  ...
  def testLeaderAndIsrRequest(currentBrokerEpoch: Long, brokerEpochInRequest: Long, expectedError: Errors): Unit = {
    ...
    val simulatedResponse = readResponse(leaderAndIsrRequest, capturedResponse)
      .asInstanceOf[LeaderAndIsrResponse]
    assertEquals(expectedError, simulatedResponse.error())
    EasyMock.verify(replicaManager)
  }
  ...
  def testStopReplicaRequest(currentBrokerEpoch: Long, brokerEpochInRequest: Long, expectedError: Errors): Unit = {
    ...
    val response = readResponse(stopReplicaRequest, capturedResponse)
  ...
  def testListGroupsRequest(): Unit = {
    ...
    val response = listGroupRequest(None, overviews).asInstanceOf[ListGroupsResponse]
  ...
  def testListGroupsRequestWithState(): Unit = {
    ...
    val response = listGroupRequest(Some("Stable"), overviews).asInstanceOf[ListGroupsResponse]
    assertEquals(1, response.data.groups.size)
    assertEquals("Stable", response.data.groups.get(0).groupState)
  }

  private def listGroupRequest(state: Option[String], overviews: List[GroupOverview]): AbstractResponse = {
    EasyMock.reset(groupCoordinator, clientRequestQuotaManager, requestChannel)
    ...
    val response = readResponse(listGroupsRequest, capturedResponse)
      .asInstanceOf[ListGroupsResponse]
