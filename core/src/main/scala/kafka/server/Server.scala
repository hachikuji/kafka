...
private[kafka] case class KafkaAuthorizerServerInfo(
...
object Server {
  ...
  val SUPPORTED_FEATURES = Collections.unmodifiableMap[String, VersionRange](Map[String, VersionRange]().asJava)
