...
public class WorkerSinkTaskTest {
    ...
    public void testMissingTimestampPropagation() throws Exception {
        expectInitializeTask();
        expectConsumerPoll(1, LogEntry.NO_TIMESTAMP, TimestampType.NO_TIMESTAMP_TYPE);
        expectConversionAndTransformation(1);
    ...
    private void expectConsumerPoll(final int numMessages) {
        expectConsumerPoll(numMessages, LogEntry.NO_TIMESTAMP, TimestampType.NO_TIMESTAMP_TYPE);
    }
